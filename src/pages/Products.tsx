...
const Products = () => {
  ...
  const products = [
    ...
    // CHOCOLINO - Cocoa & Chocolate
    {
      ...
      backImage: '/lovable-uploads/6a5f731c-aaec-45f1-80a7-4ebb9c7da0f9.png',
    ...
    },
    {
      ...
      backImage: '/lovable-uploads/d2135936-6ac6-4369-9035-f3cd9ef0eb2c.png',
    ...
    },
    {
      ...
      backImage: '/lovable-uploads/cdc730a9-a3cb-43b1-abaf-20dcdd4e19bb.png',
