        ...
        <div className="animate-fade-in w-full">
          ...
          <div className="space-y-4 sm:space-y-3 mb-6 sm:mb-12 w-full">
            ...
            <div className="relative px-2 sm:px-8 py-6 sm:py-12 lg:py-16 overflow-visible w-full">
              <h1 className="font-inter text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-bold leading-[1.2] sm:leading-[1.15] lg:leading-[1.1] text-center w-full break-words">
                <span 
