      ...
      <div className="relative z-10 text-center max-w-6xl mx-auto px-4 py-8">
        <div className="animate-fade-in">
          ...
          <div className="space-y-8 mb-12">
            <Badge className="bg-emerald-400/90 backdrop-blur-md text-white border border-emerald-300/50 px-6 py-3 text-sm font-medium rounded-full shadow-lg hover:bg-emerald-500/90 transition-all duration-300 hover:scale-105 animate-[float_12s_ease-in-out_infinite]">
