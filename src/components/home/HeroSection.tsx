  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-black/60 via-black/40 to-black/50 sm:from-black/40 sm:via-black/20 sm:to-black/30"></div>
        <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-black/50 sm:from-black/50 sm:to-black/30"></div>
      </div>
      ...
      <div className="relative z-10 text-center max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-12">
        <div className="animate-fade-in">
          ...
          <div className="space-y-4 sm:space-y-8 mb-6 sm:mb-12">
            ...
            <div className="relative px-1 sm:px-6 py-2 sm:py-6 overflow-hidden">
              <h1 className="font-playfair text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-bold leading-[1.1] sm:leading-tight text-center">
                <span 
            ...
            <div className="relative px-2 sm:px-4 max-w-5xl mx-auto">
              <p className="font-inter text-sm xs:text-base sm:text-lg md:text-xl lg:text-2xl text-white leading-relaxed sm:leading-relaxed text-center"
                 style={{
